...
export function MarketCard({ market, profile, selectedGroupRole, maxBet, busyAction, requireVenmoForBets, draft, onUpdateTradeDraft, onSavePosition, onConfirmPosition, onRejectPosition, onResolveMarket, onConfirmMarketResolution, onDeleteMarket, onMarkPayoutSent, onRespondToPayout, onMarkCollectionSettled }) {

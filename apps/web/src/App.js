...
export default function App() {
    ...
    return (_jsxs("main", { className: "shell app-shell", children: [_jsx("section", { className: "dashboard-toolbar", children: _jsxs("div", { className: "toolbar-meta", children: [_jsxs("div", { className: "toolbar-balance", children: [_jsx("span", { className: "metric-label", children: "Available balance" }), _jsx("strong", { children: formatMoney(profile?.user.balance ?? 0) })] }), _jsxs("div", { className: "toolbar-actions", children: [_jsx("button", { className: "toolbar-button", type: "button", onClick: () => setSettingsOpen((current) => !current), children: settingsOpen ? "Close settings" : "Settings" }), _jsx("button", { className: "toolbar-button toolbar-button-secondary", onClick: () => logout({
                                        logoutParams: {
